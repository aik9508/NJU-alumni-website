...
<ul class="member-intro">
    <li>
        <div class="member-thumnail">
            <img class="img-responsive" src="images/Chairmen-avatar/jihong.jpg" alt="activity thumnail">
        </div>
    ...
    <li>
        <div class="member-thumnail">
            <img class="img-responsive" src="images/Chairmen-avatar/liuqunkai.jpg" alt="activity thumnail">
        </div>
        <div class="member-description">
            <p>
                LIU Qunkai</p>
    ...
    <li>
        <div class="member-thumnail">
            <img class="img-responsive" src="images/Chairmen-avatar/shiyujie.jpg" alt="activity thumnail">
        </div>
        <div class="member-description">
            <p>
                SHI Yujie</p>
    ...
    <li>
        <div class="member-thumnail">
            <img class="img-responsive" src="images/Chairmen-avatar/jiaxiaoping.jpg"
                 alt="activity thumnail">
        </div>
        <div class="member-description">
            <p>
                JIA Xiaoping</p>
    ...
    <li>
        <div class="member-thumnail">
            <img class="img-responsive" src="images/Chairmen-avatar/peicheng.jpg" alt="activity thumnail">
        </div>
        <div class="member-description">
            <p>
                PEI Cheng</p>
    ...
    <li>
        <div class="member-thumnail">
            <img class="img-responsive" src="images/Chairmen-avatar/shaohui.jpg" alt="activity thumnail">
        </div>
        <div class="member-description">
            <p>
                SHAO Hui</p>
    ...
    <li>
        <div class="member-thumnail">
            <img class="img-responsive" src="images/Chairmen-avatar/zhangyi.jpg" alt="activity thumnail">
        </div>
        <div class="member-description">
            <p>
                ZHANG Yi</p>
