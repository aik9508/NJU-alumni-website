...
<div id="profil" class="vertical-center">
    <div class="profil-header">
        <div class="profil-title">
            <span id="profil-name"><?php echo htmlspecialchars(ucfirst($alumnus->prenom)) . " " . htmlspecialchars(ucfirst($alumnus->nom)); ?></span>
            <?php
    ...
    <?php if ($display) { ?>
            ...
            <div class="flipper">
                ...
                <div class="profil-info">
                    ...
                    if ($fonction || $entreprise) {
                        ...
                        if ($entreprise) {
                            echo "<li> 就职单位: " . htmlspecialchars($entreprise) . "</li>";
                        }
                        if ($fonction) {
                            echo "<li> 职位:&nbsp;&nbsp; " . htmlspecialchars($fonction) . "</li>";
                        }
                        echo "</ul>";
                    }
                    ?>
        ...
        <div class="profil-edit-wrapper display-none">
            ...
            <div class="col-sm-6">
                <label>姓: </label>
                <div class="tooltip">
                    <input class="input-short form-control" type="text" name="nom" placeholder="姓" <?php echo "value=" . htmlspecialchars(ucfirst($alumnus->nom)) ?>>
            ...
            <div class="col-sm-6">
                <label>名: </label>
                <div class="tooltip">
                    <input class="input-short form-control" type="text" name="prenom" placeholder="名" <?php echo "value=" . htmlspecialchars(ucfirst($alumnus->prenom)) ?>>
                    <span class="tooltiptext"></span>
                </div>
            </div>
            <div class="col-sm-12">
